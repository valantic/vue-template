<template>
  <l-default>
    <div :class="b()">
      ...
      <div :class="b('selector')">
        <c-notification-container display-type="selector" selector="2"/>
        <e-button style="margin-top: 10px; margin-right: 10px;" @click="addSelectorInfo2">Selector Info (2)</e-button>
      </div>
      <div :class="b('selector')">
        <c-notification-container display-type="selector" selector="3"/>
        <e-button style="margin-top: 10px; margin-right: 10px;" @click="addSelectorInfo3">Selector Info (3)</e-button>
      </div>
...
<script>
  ...
  export default {
    ...
    mounted() {
      notificationData.forEach(notification => this.pushNotification(notification));
    },
    methods: {
      ...
      addSelectorInfo2() {
        api.post('/notifications/selector/info2', {}, { expire: true });
      },
      addSelectorInfo3() {
        api.post('/notifications/selector/info3', {}, { expire: true });
      },
    }
  };
</script>
