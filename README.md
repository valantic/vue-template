...
* For the available css-vars check the theme files: `static/css/theme-01.css`
* Vue mixin for including theme class-names into component `app/mixins/themes.js`
* The current theme is always in the store saved `app/store/modules/session/index.js`
